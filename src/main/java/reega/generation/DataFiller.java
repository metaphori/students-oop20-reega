...
public interface DataFiller {
	 ...
	 * for every service of every contract, following these cadences: - for water,
	 * electric energy and gas: new data every hour. - for plastic, glass, paper and
	 * mixed wastes: new data every day.
	 *
